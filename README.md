...
3. <b> \src폴더 <b>에는  
 ...
 4. 이제 App.vue 파일을 보도록 하겠습니다. 이제까지  실습했던 파일과 좀 다릅니다. 우리는 이제껏 (3) 처럼 사용했는데 App.vue에는  ``` <template> ~~ import HelloWorld from './components/ ~~    export default ``` 뭐 이런것들이 보입니다.   
여기에서는 파일들의 관계와 어떤 폴더에 어떤 파일이 있는지를 주의깊게 보기만 하면 됩니다. 
 -끝-
